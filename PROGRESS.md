...
- **⏳ SONRAKİ ADIM**: backend Fly deploy (`flyctl deploy --depot=false`); yeni mobil build (bildirim + Faz 31 birlikte); istenirse eski şişmiş test seanslarını DB'den temizle.
