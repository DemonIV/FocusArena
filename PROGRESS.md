...
- **🔄 iOS production build BAŞLATILDI** (24 Tem, `eas build -p ios --profile production --auto-submit`, JS-only → Faz 31+32 birlikte; auto-submit TestFlight'a zincirlenir). Cihaz testleri build sonrası.
